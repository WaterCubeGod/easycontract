...
public class GiftContractPromptStrategy implements PromptStrategy {
    ...
    public String generatePrompt(String context, String content) {
        ...
        prompt.append("\n\n请根据上述需求生成一份完整的赠与合同，包括但不限于以下部分：\n");
        prompt.append("1. 合同标题\n");
        prompt.append("2. 赠与人和受赠人信息\n");
        prompt.append("3. 赠与标的物描述（包括名称、数量、价值等）\n");
        prompt.append("4. 赠与的目的和条件（如有）\n");
        prompt.append("5. 赠与的交付方式和时间\n");
        prompt.append("6. 赠与的撤销条件（如有）\n");
        prompt.append("7. 税费承担\n");
        prompt.append("8. 争议解决方式\n");
        prompt.append("9. 其他条款\n");
